...
enum ConsoleColor {
  ...
  /// Change text color for all future output
  String get enableForeground =>
      '$ansiEscapeLiteral[38;2;$r;$g;${b}m';

  /// Change background color for all future output
  ...
  String applyForeground(String text) {
    return '$ansiEscapeLiteral[38;2;$r;$g;${b}m$text${ConsoleColor.reset}';
  }

  /// Apply background color to text
  String applyBackground(String text) {
    return '$ansiEscapeLiteral[48;2;$r;$g;${b}m$text${ConsoleColor.reset}';
  }
}
